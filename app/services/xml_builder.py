...
class XMLBuilder:
    ...
    def _calcular_totales(self):
        ...
        if tipo in TIPOS_BOLETA:
            ...
            # IVA acumulado sobre MontoItem ya redondeado (monto_item_int) — el SII
            # calcula el IVA sobre el monto entero que aparece en el Detalle, no
            # sobre el decimal interno sin redondear.
